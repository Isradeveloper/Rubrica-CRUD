let usuarios = [
  {
    id: 1,
    cedula: "1007118795",
    nombres: "ISRAEL DAVID",
    apellidos: "TRUJILLO DOMÍNGUEZ",
    genero: "MASCULINO",
  ...
  },
  {
    ...
    cedula: "1004344795",
    nombres: "MOISÉS",
    apellidos: "CANTILLO BASTIDAS",
    genero: "MASCULINO",
    email: "moicanbas@gmail.com",
    celular: "3031487334",
    ...
    filasHTML += `
      <tr>
        ...
        <td class="col-1">
          ...
          <button class="btn btn-warning col-12 mt-2" onclick="abrirEditar(${usuario.id})"><i class="bi bi-pen-fill "></i>
          </button>
        </td>
      </tr>
    `;
...
const abrirEditar = (id) => {
  var myModal = new bootstrap.Modal(
    document.getElementById("formulario-editar")
  );
  myModal.show();
  ...
  document.getElementById(
    "formulario-editarLabel"
  ).innerText = `Editar usuario ${usuario.id} - ${usuario.cedula}`;

  document.getElementById("id-user").innerText = `${usuario.id}`;

  document.getElementById("cedula2").value = `${usuario.cedula}`;

  document.getElementById("nombres2").value = `${usuario.nombres}`;

  document.getElementById("apellidos2").value = `${usuario.apellidos}`;

  if (usuario.genero == "MASCULINO") {
    document.getElementById("genero3").checked = true;
  } else {
    document.getElementById("genero4").checked = true;
  }

  document.getElementById("email2").value = `${usuario.email}`;

  document.getElementById("celular2").value = `${usuario.celular}`;

  document.getElementById("direccion2").value = `${usuario.direccion}`;
...
const enviarEditar = () => {
  ...
  const formInputs = document.querySelectorAll("#formulario-editar form input");
  ...
  if (valido) {
    actualizarUsuario({
      id: parseInt(document.getElementById("id-user").innerHTML),
      cedula: document.querySelector("#cedula2").value,
      nombres: document.querySelector("#nombres2").value,
      apellidos: document.querySelector("#apellidos2").value,
      genero: genero,
      email: document.querySelector("#email2").value,
      celular: document.querySelector("#celular2").value,
      direccion: document.querySelector("#direccion2").value,
    });
  }
};
